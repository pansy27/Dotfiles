...
theme.bg_urgent     = theme.colors.purple
theme.bg_minimize   = theme.colors.dark_blue
theme.bg_systray    = theme.bg_normal

theme.fg_focus      = theme.colors.blue
theme.fg_normal     = theme.colors.my_white
theme.fg_urgent     =  theme.colors.dark_blue
...
-- Titlebars
theme.titlebar_bg_focus = theme.colors.dark_blue
theme.titlebar_bg_normal = theme.colors.blue
...
theme.notification_bg = theme.colors.silly_fg
theme.notification_fg = theme.colors.silly_bg
...
-- Taglist 
theme.taglist_fg_focus = theme.colors.dark_purple
theme.taglist_fg_empty = theme.colors.slate_grey
...
-- Layout box icons
theme.layout_floating  = themes_path.."layouts/dark/floating.svg"
theme.layout_max = themes_path.."layouts/dark/maximized.svg"
theme.layout_fullscreen = themes_path.."layouts/dark/fullscreenw.svg"
theme.layout_tile = themes_path.."layouts/dark/tile.svg"

-- Wibar
theme.wibar_shape = common.rrect(5)

-- Menu
theme.menu_submenu_icon = themes_path.."menu-dark.svg"
